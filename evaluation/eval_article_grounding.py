...
################################################################################
def evaluate_article_grounding(ants, results, taxonomy, split, tiou_thresholds):
...
def main(args):
    ...
    annotations = json.load(open(args.annotations_json))
    predictions = pd.read_csv(open(args.predictions_csv))

    grounding_map = evaluate_article_grounding(annotations,
                                               predictions,
                                               taxonomy,
                                               args.split,
                                               args.tiou_thresholds)    
